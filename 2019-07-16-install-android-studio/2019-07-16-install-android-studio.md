...
Помните, что не всегда самая последняя версия JDK подойдет. Например, на август 2020 года Java 14 вызывает ошибку `Cause: invalid type code: 1C`.
...
![Запущенная бета версия программы](img/preview_04.png)
